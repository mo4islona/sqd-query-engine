I need to build a new super-performant query engine.  

Allowing to query arbitrary parquet files and do joins.

We have current implementation but schemadataset  is hardcoded and 
- we cant use any code from that repo directly (by political reasons) 
...
Prepare a step-by-step plan and think what we can speed-up.
